...
<row class="justify-content-center">
    <div class="col-lg-12">
            ...
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="blogTitle" name="blogTitle" placeholder="Enter Blog Title" data-validation="length" data-validation-length="min20">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="blogContent" class="summernote"></textarea>
                        </div>
                    </div>
        ...
        <?php
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <button type="submit" name="addBlog" class="btn btn-primary">Post New Blog</button>
                        </div>
                    </div>
                <!--modal-->
                    <?php
